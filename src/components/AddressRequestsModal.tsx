...
{emailBody}
              ...
              <div className="mt-2 flex items-center gap-1.5 flex-wrap">
                <button onClick={copyEmail} className="inline-flex items-center gap-1 px-1.5 py-0.5 text-[10px] rounded border border-slate-300 hover:bg-slate-50">
                  <Copy className="h-2.5 w-2.5" /> {copied ? 'Copied!' : 'Copy message'}
                </button>
                <button onClick={copyEmailAddress} className="inline-flex items-center gap-1 px-1.5 py-0.5 text-[10px] rounded border border-slate-300 hover:bg-slate-50">
                  <Copy className="h-2.5 w-2.5" /> {copiedEmailAddress ? 'Copied!' : 'Copy email address'}
                </button>
                <button onClick={copyLink} className="inline-flex items-center gap-1 px-1.5 py-0.5 text-[10px] rounded border border-slate-300 hover:bg-slate-50">
                  <Link2 className="h-2.5 w-2.5" /> {copiedLink ? 'Copied!' : 'Copy link'}
                </button>
                <a href={mailto} className="inline-flex items-center gap-1 px-1.5 py-0.5 text-[10px] rounded border border-slate-300 hover:bg-slate-50">
